...
connection = oracledb.connect('g23madhura/g23madhura123@54.224.209.13:1521/xe@g23madhura_dblink_classicmodels')
cursor = connection.cursor()

for table_name in table_names:
    cursor.execute(f"SELECT * FROM {table_name} where to_char(update_timestamp,'yyyy-mm-dd')>='2005-06-14' ")
